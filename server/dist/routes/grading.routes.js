...
router.get('/', (0, role_middleware_1.restrictTo)('ADMIN', 'TEACHER', 'STUDENT', 'PARENT'), gradingController.getGrades);
// 2. Submit/Update Grades (Teachers Only)
router.post('/', (0, role_middleware_1.restrictTo)('TEACHER', 'ADMIN'), gradingController.submitGrade);
